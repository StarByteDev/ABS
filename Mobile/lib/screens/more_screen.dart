        ...
        children: [
          AbsCard(
            gradient: const LinearGradient(
              colors: [Color(0xFF17152D), Color(0xFF0B1421)],
            ),
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        JsonTools.text(user['name'], 'ABS Member'),
                ...
                StatusChip(
                  session.hasPulseAccess ? 'PULSE ACTIVE' : 'ABS',
                  good: session.hasPulseAccess,
                ),
              ],
            ),
          ),
            ...
            _MoreGrid(
              items: [
                _MoreItem(
                  Icons.radar_rounded,
                  'Market Scan',
                  () => _push(context, const ScannerScreen()),
                ),
                _MoreItem(
                  Icons.psychology_alt_outlined,
                  'Strategies',
                  () => _push(context, const StrategiesScreen()),
                ),
                _MoreItem(
                ...
                _MoreItem(
                  ...
                  'Economic Calendar',
                  () => _push(context, const EconomicCalendarScreen()),
                ),
                _MoreItem(
                ...
                _MoreItem(
                  ...
                  'Research',
                  () => _push(context, const ResearchScreen()),
                ),
                _MoreItem(
                  Icons.school_outlined,
                  'Learning',
                  () => _push(context, const LearningScreen()),
                ),
                _MoreItem(
            ...
            _MoreGrid(
              items: [
                ...
                _MoreItem(
                  ...
                  'Trade History',
                  () => _push(context, const TradeHistoryScreen()),
                ),
                _MoreItem(
                  Icons.star_outline_rounded,
                  'Watchlist',
                  () => _push(context, const WatchlistScreen()),
                ),
            ...
            _MoreGrid(
              items: [
                _MoreItem(
                  ...
                  () => _push(
                    context,
                    const TradingSetupScreen(initialSection: 'binance'),
                  ),
                ),
                _MoreItem(
                  ...
                  () => _push(
                    context,
                    const TradingSetupScreen(initialSection: 'risk'),
                  ),
                ),
                _MoreItem(
                  ...
                  () => _push(
                    context,
                    const TradingSetupScreen(initialSection: 'markets'),
                  ),
                ),
                _MoreItem(
                  Icons.tune_rounded,
                  ...
                  () => _push(
                    context,
                    const TradingSetupScreen(initialSection: 'execution'),
                  ),
                ),
              ],
            ),
          ...
          _MoreGrid(
            items: [
              _MoreItem(
                ...
                'Free Signal',
                () => _push(context, const FreeSignalScreen()),
              ),
              _MoreItem(
              ...
              _MoreItem(
                ...
                'Subscription',
                () => _push(context, const PlansScreen()),
              ),
              _MoreItem(
                Icons.shield_outlined,
                'Security',
              ...
              _MoreItem(
                ...
                'Notifications',
                () => _push(context, const AccountNotificationsScreen()),
              ),
              _MoreItem(
                Icons.phone_android_rounded,
                'Devices',
                () => _push(context, const RegisteredDevicesScreen()),
              ),
            ],
          ),
          const SizedBox(height: 18),
          ...
          _MoreGrid(
            items: [
              ...
              _MoreItem(
                ...
                'Legal & Risk',
                () => _push(context, const LegalHubScreen()),
              ),
            ],
          ),
          const SizedBox(height: 18),
          OutlinedButton.icon(
            ...
            icon: const Icon(Icons.logout_rounded, color: AbsColors.red),
