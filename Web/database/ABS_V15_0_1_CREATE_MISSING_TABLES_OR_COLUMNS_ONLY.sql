-- ABS V15.0.0 — Pulse Points / Gamification / Best Signal
...
-- ABS V15.0.1 commerce reconciliation ---------------------------------------
...
('membership_requests_enabled','0','boolean','membership','Legacy direct membership requests are disabled in ABS V15.0.1. Plans activate with Pulse Points.'),
