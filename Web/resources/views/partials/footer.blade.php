<footer class="site-footer final-site-footer">
    <div class="container final-footer-grid">
        ...
        <nav aria-label="Platform links"><h4>PLATFORM</h4><a href="{{ route('pulse.entry') }}">Pulse Intelligence</a><a href="{{ route('news.index') }}">ABS News</a><a href="{{ route('pulse.entry') }}">Research Reports</a><a href="{{ route('tools') }}">Tools &amp; Calculators</a><a href="{{ route('pulse.entry') }}">Alerts &amp; Watchlists</a></nav>
    ...
    <div class="container">@include('partials.market-disclaimer')</div>
    <div class="container final-footer-bottom">
        <span>© {{ date('Y') }} Alpha Block Solutions. All rights reserved.</span>
        <span>No investment advice · No guaranteed returns · Verify market data independently.</span>
    </div>
</footer>
