...
<section class="container search-results">
    ...
    @empty
        @if($q)
            <div class="panel empty-state"><h2>No active content matched “{{ $q }}”.</h2><p>Try a broader term or open Pulse, Live Markets or Market News directly.</p><div class="hero-actions"><a class="button button-ghost" href="{{ route('pulse.entry') }}">Explore Pulse</a><a class="button button-ghost" href="{{ route('news.index') }}">Open Market News</a></div></div>
        @else
